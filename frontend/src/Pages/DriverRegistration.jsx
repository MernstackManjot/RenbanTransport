    ...
    return (
        <div className='flex justify-center items-center mt-4'>
            <div className="max-w-5xl md:max-w-5xl mx-auto p-4">
                <h1 className="text-2xl md:text-3xl font-bold mb-4 text-red-700">Driver Registration Form</h1>
                ...
                <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" onSubmit={handleSubmit}>
                    ...
                    <button
                         className={` w-60 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline  ${isSubmitting ? 'bg-red-400 cursor-not-allowed' : 'bg-red-700 hover:bg-gradient-to-t from-red-500 to-red-700'} `}
                        type="submit"
