    ...
    return (
        <div className='flex justify-center items-center mt-4'>
            <div className="max-w-4xl md:max-w-5xl mx-auto p-4">
                <h1 className="text-2xl md:text-3xl font-bold mb-4 text-red-700">Vehicle Registration Form</h1>
                <p className="text-lg md:text-lg mb-6">
                At Renban Transport, we prioritize safety, reliability, and professionalism in all our operations. To maintain 
                ...
                <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" onSubmit={handleSubmit}>
                    ...
                    <button
                        className={`bg-red-500  w-60 text-white font-bold py-2 px-5 mt-10  rounded focus:outline-none focus:shadow-outline  ${isSubmitting ? 'bg-red-400 cursor-not-allowed' : 'bg-red-700 hover:hover:bg-gradient-to-t from-red-500 to-red-700'} `}
                        type="submit"
